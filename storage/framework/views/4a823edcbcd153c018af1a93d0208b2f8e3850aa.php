...
<section class="content-header">   
  ...
  <div class='form-group col-md-12 col-xs-12' style='padding-left: 0px'>
    <div class='btn-group col-md-8 col-xs-12 ' style='padding-left: 0px'>
      <a class="btn btn-default col-md-3 col-xs-6 "  href="<?php echo e(route('it.lista')); ?>">Lista</a>
      <a class="btn btn-success col-md-3 col-xs-6 "  href="<?php echo e(route('it.andamento')); ?>">Andamento</a>
