...
<section class="">
    ...
    <div class="col-xs-12"> 
        ...
        <div class="box-body"> 
            <?php $__env->startComponent('components.show.andamento',['module' => 'adl','proc' => $proc]); ?><?php echo $__env->renderComponent(); ?>
            <?php $__env->startComponent('components.show.andamentocoger',['module' => 'adl','proc' => $proc]); ?><?php echo $__env->renderComponent(); ?>              
            <div class="col-md-12 col-xs-12">
                <p><strong>Documentos de origem:</strong></p><p> <?php echo e($proc['doc_origem_txt']); ?></p>
            </div>
            <?php $__env->startComponent('components.show.data',['title' => 'Data do fato','proc' => $proc['fato_data']]); ?><?php echo $__env->renderComponent(); ?>
            <?php $__env->startComponent('components.show.opm',['proc' => $proc]); ?><?php echo $__env->renderComponent(); ?>
            <?php $__env->startComponent('components.show.item',['title' => 'Motivo','proc' => sistema('motivoFATD',$proc['motivo_fatd']) ]); ?><?php echo $__env->renderComponent(); ?>
            <?php $__env->startComponent('components.show.item',['title' => 'Outros Motivos','proc' => $proc['motivo_outros']]); ?><?php echo $__env->renderComponent(); ?>
            <?php $__env->startComponent('components.show.item',['title' => 'Situação','proc' => sistema('situacaoOCOR',$proc['situacao_fatd']) ]); ?><?php echo $__env->renderComponent(); ?>
            <?php $__env->startComponent('components.show.sintese',['proc' => $proc['sintese_txt'] ]); ?><?php echo $__env->renderComponent(); ?>
            <?php $__env->startComponent('components.show.item',['title' => 'Nº do despacho que designa o Encarregado','proc' => $proc['despacho_numero']]); ?><?php echo $__env->renderComponent(); ?>
            <?php $__env->startComponent('components.show.data',['title' => 'Data do despacho','proc' => $proc['portaria_data']]); ?><?php echo $__env->renderComponent(); ?>
            <?php $__env->startComponent('components.show.item',['title' => 'Situação','proc' => sistema('situacaoOCOR',$proc['situacao_fatd']) ]); ?><?php echo $__env->renderComponent(); ?>
            ...
            <?php $__env->startComponent('components.show.data',['title' => 'Data da abertura','proc' => $proc['abertura_data']]); ?><?php echo $__env->renderComponent(); ?>
            <?php $__env->startComponent('components.show.doc',['title' => 'Relato do fato imputado','module' => 'adl','proc' => $proc['relato_file']]); ?><?php echo $__env->renderComponent(); ?>
            <?php $__env->startComponent('components.show.doc',['title' => 'Relatório','module' => 'adl','proc' => $proc['relatorio_file']]); ?><?php echo $__env->renderComponent(); ?>
            <?php $__env->startComponent('components.show.doc',['title' => 'Solução do Comandante','module' => 'adl','proc' => $proc['sol_cmt_file']]); ?><?php echo $__env->renderComponent(); ?>
            <?php $__env->startComponent('components.show.doc',['title' => 'Solução do Cmt Geral','module' => 'adl','proc' => $proc['sol_cg_file']]); ?><?php echo $__env->renderComponent(); ?>
            <?php $__env->startComponent('components.show.doc',['title' => 'Nota de punição','module' => 'adl','proc' => $proc['notapunicao_file']]); ?><?php echo $__env->renderComponent(); ?>
            <?php $__env->startComponent('components.show.doc',['title' => 'Publicação da nota de punição','module' => 'adl','proc' => $proc['publicacaonp']]); ?><?php echo $__env->renderComponent(); ?>
            ...
            <div class="box collapsed-box">
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-12 col-xs-12">
                        ...
                        <?php if($presidente != NULL && $presidente != ''): ?>
                            <p class="col-md-6"><?php echo e($presidente->cargo); ?> <?php echo e(special_ucwords($presidente->nome)); ?></p> 
                            <p class="col-md-6"><strong>RG:</strong> <?php echo e($presidente->rg); ?></p>
                        <?php else: ?>
                    ...
                    <div class="col-md-12 col-xs-12">
                        ...
                        <?php if($escrivao != NULL && $escrivao != ''): ?>
                            <p class="col-md-6"><?php echo e($escrivao->cargo); ?> <?php echo e(special_ucwords($escrivao->nome)); ?></p> 
                            <p class="col-md-6"><strong>RG:</strong> <?php echo e($escrivao->rg); ?></p>
                        <?php else: ?>
                            <p class="col-md-12">Não Há</p>
                        <?php endif; ?>
                    </div>
