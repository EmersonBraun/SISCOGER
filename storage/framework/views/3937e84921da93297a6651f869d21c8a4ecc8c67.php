<?php $__env->startSection('title', 'CD - Andamento '); ?>

<?php $__env->startSection('content_header'); ?>
    <?php echo $__env->make('procedimentos.cd.list.menu', ['title' => 'Andamento','page' => 'andamento'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                ...
                <table id="datable" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-danger"  href="<?php echo e(route('cd.destroy',$registro['id_cd'])); ?>"><i class="fa fa-fw fa-trash-o "></i></a>
                        </span>
                    </td>   
                  </tr>
