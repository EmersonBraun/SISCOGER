...
<?php $__env->startSection('title', 'FATD - Lista'); ?>
...
<section class="content-header nopadding">   
  ...
  <li class="active">FATD - Lista</li>
  </ol>
  <br>
  <div class='form-group col-md-12 col-xs-12' style='padding-left: 0px'>
    <div class='btn-group col-md-8 col-xs-12 ' style='padding-left: 0px'>
      <a class="btn btn-success col-md-2 col-xs-4 "  href="<?php echo e(route('fatd.lista',['ano' => $ano])); ?>">Lista</a>
    ...
    <div class='col-md-2 col-xs-6  pull-right'>
      ...
      title="O ano apenas modifica a listagem,os dados continuam sendo inseridos em <?php echo e(date('Y')); ?>"> 
        ...
        <?php for($i = date('Y'); $i >= 2008; $i--): ?>
          <?php if($i != $ano): ?>
            <option onclick="javascript:location.href='<?php echo e(route('fatd.lista',['ano' => $i])); ?>'"> <?php echo e($i); ?> </option>
          <?php endif; ?>
        <?php endfor; ?>  
      </select> 
      </div>
                ...
                <table id="datable" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-danger"  href="<?php echo e(route('fatd.destroy',$registro['id_fatd'])); ?>" onclick="confirmApagar('fatd',$registro['sjd_ref'],$registro['sjd_ref_ano'])"><i class="fa fa-fw fa-trash-o "></i></a>
                        </span>
                    </td>   
                  </tr>
