...
<?php $__env->startSection('content_header'); ?>
    <?php echo $__env->make('procedimentos.cj.list.menu', ['title' => 'Consulta','page' => 'lista'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
              ...
              <div class="box-body">
                <table id="datable" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <?php else: ?>
                    <td><?php echo e(sistema('decorrenciaConselho',$registro['id_decorrenciaconselho'])); ?></td>
                    <?php endif; ?>
