...
<section class="content-header">   
  ...
  <div class='form-group col-md-12 col-xs-12' style='padding-left: 0px'>
    <div class='btn-group col-md-8 col-xs-12 ' style='padding-left: 0px'>
      <a class="btn btn-success col-md-2 col-xs-4 "  href="<?php echo e(route('ipm.lista')); ?>">Lista</a>
              ...
              <div class="box-body">
                <table id="datable" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td class='col-xs-2 col-md-2'><?php echo e(opm($registro['ipmopm'])); ?></td>
                    <td class='col-xs-6 col-md-6'><?php echo e($registro['sintese_txt']); ?></td>
                    <td class='col-xs-3 col-md-3'>
                        <span>
                        <a class="btn btn-default" href="<?php echo e(route('ipm.show',['ref' => $registro['sjd_ref'], 'ano' => $registro['sjd_ref_ano']])); ?>"><i class="fa fa-fw fa-eye "></i></a>
                        <a class="btn btn-info" href="<?php echo e(route('ipm.edit',['ref' => $registro['sjd_ref'], 'ano' => $registro['sjd_ref_ano']])); ?>"><i class="fa fa-fw fa-edit "></i></a>
                        <a class="btn btn-danger"  href="<?php echo e(route('ipm.destroy',$registro['id_ipm'])); ?>" onclick="confirmApagar('ipm',$registro['sjd_ref'],$registro['sjd_ref_ano'])"><i class="fa fa-fw fa-trash-o "></i></a>
                        </span>
                    </td>   
                  </tr>
