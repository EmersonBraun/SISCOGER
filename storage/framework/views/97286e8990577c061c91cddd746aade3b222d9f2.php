...
<section class="content nopadding">
    ...
    <div class="row">
                ...
                $comportamento['comportamento'] == 'Insuficiente' && $comportamento['tempo'] <= 3 ||
                    ...
                    $comportamento['comportamento'] == 'Bom' && $comportamento['tempo'] <= 6 ||
                        ...
                        $comportamento['comportamento'] == 'Ótimo' && $comportamento['tempo'] <= 5 ): ?> <tr>
                            ...
                            <td><span <?php switch($comportamento['comportamento']): case ('Mau'): ?> class='label label-error'
                                    ...
                                    class='label label-default' <?php endswitch; ?>><?php echo e($comportamento['comportamento']); ?></span>
                            </td>
        ...
        <table class="table no-margin">
            ...
            <tr>
                <td><a href="<?php echo e(route('fatd.edit',['ref' =>$fatd_abertura['sjd_ref'], 'ano' => $fatd_abertura['sjd_ref_ano']])); ?>"
                        target="_blank"><?php echo e($fatd_abertura['sjd_ref']); ?>/<?php echo e($fatd_abertura['sjd_ref_ano']); ?></a></td>
        ...
        <table class="table no-margin">
            ...
            <tr>
                ...
                <td><a href="<?php echo e(route('fatd.edit',['ref' =>$fatd_punido['sjd_ref'], 'ano' => $fatd_punido['sjd_ref_ano']])); ?>"
                        target="_blank"><?php echo e($fatd_punido['sjd_ref']); ?>/<?php echo e($fatd_punido['sjd_ref_ano']); ?></a></td>
        ...
        <table class="table no-margin">
            ...
            <tr>
                <td><a href="<?php echo e(route('ipm.edit',['ref' =>$ipm_abertura['sjd_ref'], 'ano' => $ipm_abertura['sjd_ref_ano']])); ?>"
                        target="_blank"><?php echo e($ipm_abertura['sjd_ref']); ?>/<?php echo e($ipm_abertura['sjd_ref_ano']); ?></a></td>
                <td><span class='label label-danger'>não tem data de abertura cadastrada. </span></td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <tr>
        ...
        <table class="table no-margin">
            ...
            <tr>
                <td><a href="<?php echo e(route('ipm.edit',['ref' =>$ipm_prazo['sjd_ref'], 'ano' => $ipm_prazo['sjd_ref_ano']])); ?>"
                        target="_blank">
        ...
        <?php $__env->startComponent('components.comp.boxcolapse',['titulo' => 'SINDICÂNCIA - DATA DE ABERTURA', 'qtd' =>
        ...
        <table class="table no-margin">
            ...
            <tr>
                <td>
                    <a href="<?php echo e(route('sindicancia.edit',['ref' =>$sindicancia_abertura['sjd_ref'], 'ano' => $sindicancia_abertura['sjd_ref_ano']])); ?>"
                        target="_blank">
        ...
        <table class="table no-margin">
            ...
            <tr>
                <td>
                    <a href="<?php echo e(route('sindicancia.edit',['ref' =>$sindicancia_prazo['sjd_ref'], 'ano' => $sindicancia_prazo['sjd_ref_ano']])); ?>"
                        target="_blank">
        ...
        <?php $__env->startComponent('components.comp.boxcolapse',['titulo' => 'CONSELHOS DE DISCIPLINA - DATA DE ABERTURA', 'qtd' =>
        $tcd_aberturas]); ?>
        <table class="table no-margin">
            <thead>
                <tr>
            ...
            <tr>
                <td>
                    <a href="<?php echo e(route('cd.edit',['ref' =>$cd_abertura['sjd_ref'], 'ano' => $cd_abertura['sjd_ref_ano']])); ?>"
                        target="_blank">
        ...
        <table class="table no-margin">
            ...
            <tr>
                <td>
                    <a href="<?php echo e(route('cd.edit',['ref' =>$cd_prazo['sjd_ref'], 'ano' => $cd_prazo['sjd_ref_ano']])); ?>"
                        target="_blank">
