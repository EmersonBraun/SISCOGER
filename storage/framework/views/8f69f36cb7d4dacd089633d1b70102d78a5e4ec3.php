<?php $__env->startSection('title', 'IPM - Andamento'); ?>
...
<section class="content-header">   
  ...
  <div class='form-group col-md-12 col-xs-12' style='padding-left: 0px'>
    <div class='btn-group col-md-8 col-xs-12 ' style='padding-left: 0px'>
      ...
      <a class="btn btn-success col-md-2 col-xs-4 "  href="<?php echo e(route('ipm.andamento')); ?>">Andamento</a>
                ...
                <table id="datable" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-danger"  href="<?php echo e(route('ipm.destroy',$registro['id_ipm'])); ?>"><i class="fa fa-fw fa-trash-o "></i></a>
                        </span>
                    </td>   
                  </tr>
