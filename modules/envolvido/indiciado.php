...
openTR();
	openTD("colspan='5' align='center' bgcolor='#E0E0E0'");
        ...
        if (in_array($proc, $procOndeMostrarAcompanhamento)) {
            echo " | <a href=\"?module=subscription&tipo_processo={$proc}&id_processo={$$proc->$id}\">Acompanhamento</a>";
        }
        if ($user['nivel']==4 || $user['nivel']==5) {
        	echo "| <a href=\"?module=arquivo&arquivo[id_$proc]=".$$proc->$id."\">Arquivo</a>"; 
        }
	closeTD();
closeLine();
