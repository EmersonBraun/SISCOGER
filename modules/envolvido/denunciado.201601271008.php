...
openTable("class='bordasimples' width='100%'");
	...
	openTR("bgcolor='#E0E0E0'");
		echo "<td>Nome</td><td>OM atual</td><td>Procedimento</td><td>Proc Crime</td><td>Julgamento</td><td>T. julgado</td><td>Pena</td>";
	closeTR();
...
openTable("class='bordasimples' width='100%'");
	...
	//cabecalho
	openTR("bgcolor='#E0E0E0'");
		echo "<td>Nome</td><td>OM atual</td></tD><td>Origem</td><td>Proc Crime</td><td>Julgamento</td><td>T. julgado</td><td>Pena</td>";
	closeTR();

	$sql="SELECT denunciacivil.*, opm.CODIGOBASE, opm.ABREVIATURA FROM denunciacivil
