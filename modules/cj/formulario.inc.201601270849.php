...
<form ID='cj' class="controlar-modificacao" name="cj" action="index.php?module=cj" method="post" onSubmit="return validar(this);" enctype="multipart/form-data">
...
form::openTR();
	form::openTD("colspan='2'");
		form::openLabel("N&ordm; do CJ e andamento");
			...
			formulario::option("cj","andamento","WHERE procedimento='cj'","","",0);
		form::closeLabel();
	form::closeTD();
	openTD();
		form::openLabel("Andamento COGER");
			formulario::option("cj","andamentocoger","WHERE procedimento='cj'","","",0);
		form::closeLabel();
	closeTD();
form::closeTR();
