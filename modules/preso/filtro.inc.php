...
form::openTR("id='linhafiltro'");
	form::openTD();
		form::openLabel("Local da pris&atilde;o (onde o policial est&aacute; preso)");
			echo "<select name=preso[preso.cdopm_prisao_st]>";
	...
	form::openTD();
		form::openLabel("Data do in&iacute;cio da pris&atilde;o");
			...
			calendario::cria(1,"preso","preso[inicio_data_ini]");
			echo "At&eacute;&nbsp; ";
			formulario::data("preso","inicio_data_fim");
			calendario::cria(2,"preso","preso[inicio_data_fim]");
		form::closeLabel();
	form::closeTD();
...
openTR();
	openTD();
		form::openLabel("OPM atual");
			echo "<select name=preso[opm2.CODIGOBASE_st]>";
			include ("includes/option_opm.php");
			echo "</select>";
		form::closeLabel();
	closeTD();
