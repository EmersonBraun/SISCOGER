...
<form class="controlar-modificacao" ID='iso' name="iso" action="index.php?module=iso" method=post onSubmit="return validar(this);" enctype="multipart/form-data">
...
preenchimento</font></th></tr> 	<?}?>
	...
	<tr>
		...
		| <a href="?module=arquivo&arquivo[id_iso]=<?=$iso->id_iso;?>">Arquivo</a>
		<?}?>
		</td>
	</tr>
	<?}?>
...
form::openTR();
	form::openTD("width='50%' colspan=1");
		...
		formulario::option("iso","andamento","WHERE procedimento='iso'","",0,0);
		form::closeLabel();
	form::closeTD();
	openTD();
		form::openLabel("Tramite administrativo");
			formulario::option("iso","andamentocoger","WHERE procedimento='iso'","",0,0);
		form::closeLabel();
	closeTD();
	/*
...
form::openTR();
	form::openTD("colspan='1' width='50%'");
		form::input("Relat&oacute;rio do M&eacute;dico","iso[relatoriomedico_file]");
	form::closeTD();
	form::openTD("colspan='1' width='50%'");
		form::input("Data do Relat&oacute;rio","iso[relatoriomedico_data]");
	form::closeTD();
form::closeTR();

form::openTR();
	form::openTD("colspan='1' width='50%'");
		form::input("Solu&ccedil;&atilde;o da Autoridade","iso[solucaoautoridade_file]");
	form::closeTD();
	form::openTD("colspan='1' width='50%'");
		form::input("Data da Solu&ccedil;&atilde;o","iso[solucaoautoridade_data]");
	form::closeTD();
form::closeTR();
