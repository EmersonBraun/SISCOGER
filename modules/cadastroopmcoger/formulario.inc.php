    ...
    <table border=0 width=100%>
        ...
        <table border=0 width=100%>
            <tr><td>
                            ...
                            <td>
                                <table align=center border=0 cellpadding="0" cellspacing="1" width="100%">
                                    ...
                                    <tr bgcolor=white>
                                        ...
                                        <td valign="top"><input type=text size='40' name='cadastroopmcoger[opm_autoridade_nome]' id='autoridade_nome' value='<?= FHelperICO::obtemNomeConformeAIco($autoridade); ?>' readonly></td>
                    ...
                    form::closeTR();
if (isset($cadastroopmcoger->id_cadastroopmcoger)) {
                    form::openTR();
                    form::openTD(' colspan="12" ');
