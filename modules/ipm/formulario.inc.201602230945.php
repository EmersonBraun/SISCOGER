...
<form ID='ipm' class="controlar-modificacao" name="ipm" action="index.php?module=ipm" method=post onSubmit="return validar(this);" enctype='multipart/form-data'>
...
//				form::openLabel("N&ordm; da OPM");
//					if (!$ipm->opm_ref) $opm_ref=get_lastnumber("IPM","$login_unidade");
//					else $opm_ref=$ipm->opm_ref;
//					echo $opm_ref."/".$ipm->opm_ref_ano."<b> do(a) ". $ipm->opm_sigla."</b>";
//				form::closeLabel();
//			form::closeTD();
