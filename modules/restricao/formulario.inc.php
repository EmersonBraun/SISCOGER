	...
	openTD("colspan='2'");
		form::openLabel("Origem da restri&ccedil;&atilde;o");
			echo "<select name='restricao[origem]'>";
				...
				echo "<option value='Condenacao Punicao Disciplinar'>Condena��o ou Puni��o Disciplinar</option>";
				echo "<option value='Inapto Psicologico'>Inapto Avalia��o Psicol�gica</option>";
			echo "</select>";
		form::closeLabel();
	closeTD();
closeTR();
