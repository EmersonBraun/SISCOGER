...
<form id='cd' class="controlar-modificacao" name="cd" action="index.php?module=cd" method=post onSubmit="return validar(this);" enctype="multipart/form-data">
...
form::openTR();
	form::openTD("colspan='2'");
		...
		formulario::option("cd","andamento","WHERE procedimento='cd'","","",0);
		form::closeLabel();
	form::closeTD();
	openTD();
		form::openLabel("Andamento COGER");
			formulario::option("cd","andamentocoger","WHERE procedimento='cd'","","",0);
		form::closeLabel();
	closeTD();
form::closeTR();
