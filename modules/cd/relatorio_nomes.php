 ...
 ?>
	...
	<tr>
		...
		<table border=0 cellpadding=0 celindexlspacing=0>
			<tbody>
			<tr>	
				<td><b>Policial Envolvido:</b></td>
				<td>RG:<input type=text size=20 ajax=1 name=policial[rg] onblur="ajaxForm(this, 'policial',Array('nome'))" value="<?echo $policial[rg];?>"></td>
				<td>
...
<table cellpadding="5" cellspacing="1" width="100%" border="0">
		...
		if ($resultado) {
			...
			echo "<tr bgcolor=White><td colspan=7><center><b>Não há envolvimentos para o Policial Militar $policial[nome]</b></center></td></tr>";
		}
