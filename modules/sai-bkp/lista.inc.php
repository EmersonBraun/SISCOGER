...
while ($row=mysql_fetch_array($res)) {
	...
	foreach ($mostrar as $campo) {
		...
		if     ($campo=="NRSJD") echo "<td><a href='?module=sai&sai[id]=$row[id_sai]'>$row[sjd_ref]/$row[sjd_ref_ano]</a></td>";//echo "<td><a href='?module=sai&sai[id]=$row[id_sai]'>$row[id_sai]</a></td>";
