...
if ((!$opcaoGeral2)) 
{
	...
	?>
		...
		<? echo "<input type=\"hidden\" name=\"movimento[id_$procedimento]\" value=\"$idp\">";
		 ...
		 ?>
		<br>
		Inserir Movimento:<br />
		<input type="Text" name="movimento[data]" maxlength="10" readonly size="12" value="<?echo data::hoje();?>" onkeyup="MascaraData(this, event), pulaFocus(10, this, form.horaInicialCon)">
                <br>
                <textarea rows='3' cols="60" id="descricao" name="movimento[descricao]" autofocus="true"></textarea>
                <br>
                <label><input type="checkbox" name="notificar_assinantes_por_email" value="1">Notificar assinantes por e-mail.</label>
                <br>
