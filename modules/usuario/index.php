...
if ($acao=="alterar") {
		...
		if (mssql_query($sql,$con[3])) {
			echo "<h2>Dados de usuário alterados com sucesso!</h2>";
		}
		else {
			echo "<h2>Houve um problema na execução da solicitação!</h2>";
			echo "O sistema tentou executar: $sql <br>\r\n";
			echo "Por favor, copie essa mensagem e encaminhe-a ao Centro de Tecnologia da Informação para providências.";
		}
}
else {
		...
		<table width="75%" class="bordasimples">
			<tr><TD colspan="2"><h1 align="center">Informações do usuário <?echo $login;?></h1></TD></tr>
			<TR>
			...
			<tr><td>As senhas estão iguais?</td><TD><div id="senhaOK"></div></td></TD></tr>
