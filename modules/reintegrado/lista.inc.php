...
<?php
if ($opcao=="listar") echo "<tr><td colspan='6'><h2>Militares reintegrados</h2></td></tr>";
...
while ($row=mysql_fetch_array($res)) {
	...
	echo "<td>$row[bg_numero]/$row[bg_ano]</td>";
