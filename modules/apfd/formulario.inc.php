...
preenchimento</font></th></tr> 	<?}?>
	...
	<tr bgcolor='#E0E0E0'>
		...
		| <a href="?module=arquivo&arquivo[id_apfd]=<?=$apfd->id_apfd;?>">Arquivo</a>
		<?}?>
		</td>
	</tr>
	<?}?>
...
form::openTR();
	...
	form::openTD();
		form::openLabel("Andamento COGER");
			if ($user['nivel']>=4)			
			formulario::option("apfd","andamentocoger","WHERE procedimento='apfd'","",0,0);
			else
...
form::openTR();
	form::openTD("width='50%' colspan=1");
		form::openLabel("Tipo");
			...
			<option rel='none' value='Crime militar'>Crime militar</option>";
