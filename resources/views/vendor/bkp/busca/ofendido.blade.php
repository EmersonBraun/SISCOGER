...
@section('title_postfix', '| Busca Ofendido')
...
<div class=''>
    ...
    <div class="col-md-12 form-group">
        <div class="col-md-6">
            {!! Form::label('ofendido[rg]', 'RG') !!}
            {!! Form::text('ofendido[rg]', '', array('class' => 'form-control', 'id' => 'rg')) !!}
        </div>
        <div class="col-md-6">
            {!! Form::label('ofendido[nome]', 'Nome') !!}
            {!! Form::text('ofendido[nome]', '', array('class' => 'form-control','id' => 'nome'))!!}
        </div>
    </div>
