...
@include('vendor.procedimentos.fatd.form.documentos')

@include('vendor.procedimentos.fatd.form.recursos')

@include('vendor.procedimentos.fatd.form.membros')

@include('vendor.procedimentos.fatd.form.acusado')
