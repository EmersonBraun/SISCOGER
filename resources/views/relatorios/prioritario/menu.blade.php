<section class="content-header nopadding">  
    ...
    <div class="form-group col-md-12 col-xs-12 nopadding">
        ...
        <a class="btn @if($page == 'fatd') btn-success @else btn-default @endif col-md-1 col-xs-1" href="{{route('relatorio.prioritarios','fatd')}}">FATD</a>
        ...
        <a class="btn @if($page == 'sindicancia') btn-success @else btn-default @endif col-md-1 col-xs-1" href="{{route('relatorio.prioritarios','sindicancia')}}">Sindicancia</a>
