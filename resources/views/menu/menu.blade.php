...
<li class="treeview">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            <li class="">
                <a href="{{route('apfd.index')}}">
                <i class="fa fa-fw fa-circle-o "></i>
                <span>APFD</span>
                </a>
            </li>
            <li class="">
                <a href="{{route('desercao.index')}}">
                <i class="fa fa-fw fa-circle-o "></i>
                <span>Deserção</span>
                </a>
            </li>
            <li class="">
                <a href="{{route('exclusao.index')}}">
                <i class="fa fa-fw fa-circle-o "></i>
                <span>Exclusão</span>
                </a>
            </li>
            ...
            <li class="">
                <a href="{{route('sindicancia.index')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
...
<li class="treeview">
    ...
    <ul class="treeview-menu">
        ...
        <li class="">
            <a href="{{route('pendencias.gerais')}}">
            <i class="fa fa-fw fa-circle-o "></i>
        ...
        <li class="">
            <a href="{{route('pendencias.prioritarios')}}">
            <i class="fa fa-fw fa-circle-o "></i>
        ...
        <li class="">
            <a href="{{route('pendencias.sobrestamentos')}}">
            <i class="fa fa-fw fa-circle-o "></i>
        ...
        <li class="">
            <a href="{{route('pendencias.processos')}}">
            <i class="fa fa-fw fa-circle-o "></i>
            <span>Processos</span>
            </a>
        </li>
        ...
        <li class="">
            <a href="{{route('pendencias.postograd')}}">
            <i class="fa fa-fw fa-circle-o "></i>
        ...
        <li class="">
            <a href="{{route('pendencias.encarregados')}}">
            <i class="fa fa-fw fa-circle-o "></i>
        ...
        <li class="">
            <a href="{{route('pendencias.defensores')}}">
            <i class="fa fa-fw fa-circle-o "></i>
        ...
        <li class="">
            <a href="{{route('pendencias.ofendidos')}}">
            <i class="fa fa-fw fa-circle-o "></i>
            <span>Ofendidos</span>
            </a>
        </li>
...
<li class="treeview">
    ...
    <ul class="treeview-menu">
        ...
        <li class="">
            <a href="{{route('medalhas.index')}}">
            <i class="fa fa-fw fa-circle-o "></i>
            <span>Medalhas</span>
            </a>
        </li>
        <li class="">
            <a href="{{route('elogios.index')}}">
            <i class="fa fa-fw fa-circle-o "></i>
            <span>Elogios</span>
            </a>
        </li>
        <li class="">
            <a href="{{route('excluidos.index')}}">
            <i class="fa fa-fw fa-circle-o "></i>
            <span>Excluídos</span>
            </a>
        </li>
        <li class="">
            <a href="{{route('punidos.index')}}">
            <i class="fa fa-fw fa-circle-o "></i>
            <span>Punidos</span>
            </a>
        </li>
        <li class="">
            <a href="{{route('reintegrados.index')}}">
            <i class="fa fa-fw fa-circle-o "></i>
            <span>Reintegrados</span>
            </a>
        </li>
        <li class="">
            <a href="{{route('denunciados.index')}}">
            <i class="fa fa-fw fa-circle-o "></i>
        ...
        <li class="">
            <a href="{{route('comportamento.index')}}">
            <i class="fa fa-fw fa-circle-o "></i>
            <span>Comportamento</span>
            </a>
        </li>
        <li class="">
            <a href="{{route('respondendo.index')}}">
            <i class="fa fa-fw fa-circle-o "></i>
            <span>Respondendo</span>
            </a>
        </li>
        <li class="">
            <a href="{{route('restricoes.index')}}">
            <i class="fa fa-fw fa-circle-o "></i>
            <span>Restrições</span>
            </a>
        </li>
        <li class="">
            <a href="{{route('suspensos.index')}}">
            <i class="fa fa-fw fa-circle-o "></i>
            <span>Suspensos</span>
            </a>
        </li>
        <li class="">
            <a href="{{route('obitoslesoes.index')}}">
            <i class="fa fa-fw fa-circle-o "></i>
            <span>Obitos e Lesões</span>
            </a>
        </li>
        <li class="">
            <a href="{{route('mortosferidos.index')}}">
            <i class="fa fa-fw fa-circle-o "></i>
...
<li class="treeview">
    ...
    <ul class="treeview-menu">
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li class="">
                    <a href="{{route('log.adl')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - ADL</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.apfd')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - APFD</span>
                    </a>
                </li>
                ...
                <li class="">
                    <a href="{{route('log.desercao')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Deserção</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.exclusao')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Exclusão</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.fatd')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - FATD</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.ipm')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - IPM</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.iso')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - ISO</span>
                    </a>
                </li>
                ...
                <li class="">
                    <a href="{{route('log.movimento')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Movimento</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.pad')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - PAD</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.procoutros')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Proc. Outros</span>
                    </a>
                </li>                            
                <li class="">
                    <a href="{{route('log.sindicancia')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Sindicância</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.recurso')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li class="">
                    <a href="{{route('log.notacoger')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Notas COGER</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.apresentacao')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Apresentação</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.locaisapresentacao')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Locais</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.email')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Email</span>
                    </a>
                </li>
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li class="">
                    <a href="{{route('log.acessos')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Acessos</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.apagados')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Apagado</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.bloqueios')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Bloqueios</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.papeis')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Papeis</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.permissoes')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Permissões</span>
                    </a>
                </li> 
                    <li class="">
                    <a href="{{route('log.feriados')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li class="">
                    <a href="{{route('log.fdi')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - FDI</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.cadastroopmcoger')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Cadastro OPM COGER</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.comportamentopm')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Comportamento PM</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.denunciacivil')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Denuncia Civil</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.elogio')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Elogio</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.reintegrado')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Reintegrado</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.falecimento')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Falecimento</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.preso')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Preso</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.restricao')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Restrição</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.sai')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - SAI</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.suspenso')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
                    <span>Log - Suspenso</span>
                    </a>
                </li>
                <li class="">
                    <a href="{{route('log.tramitacaoopm')}}">
                    <i class="fa fa-fw fa-circle-o "></i>
