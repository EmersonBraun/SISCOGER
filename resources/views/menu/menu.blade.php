...
<li class="treeview">
    ...
    <ul class="treeview-menu">
        ...
        <li class=""><a href="{{ route('apresentacao.index',['ano' => date('Y'), 'mes' => num_dois_digitos((int) date('m'), true), 'cdopm' => session('cdopmbase')])}}"><i class="fa fa-fw fa-circle-o "></i><span>Lista apresentações</span></a></li>
        @endif
        {{-- @if(hasPermissionTo('listar-apresentacao'))
...
<li class="treeview">
    ...
    <ul class="treeview-menu">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu"> 
                <li class=""><a href="{{ route('relatorio.abuso','fatd')}}"><i class="fa fa-fw fa-circle-o "></i><span>Assédio/Abuso Sexual</span></a></li> 
                <li class=""><a href="{{ route('relatorio.violenciadomestica','fatd')}}"><i class="fa fa-fw fa-circle-o "></i><span>Violência Doméstica</span></a></li> 
            </ul>
        </li> 
    </ul>
</li>
