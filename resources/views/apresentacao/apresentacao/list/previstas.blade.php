...
@include('apresentacao.apresentacao.list.menu', ['title' => 'Previstas','page' => 'previstas','cdopm' => session('cdopmbase'), 'ano' => date('Y'), 'mes' => num_dois_digitos((int) date('m'), true)])
@stop
    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Listagem Apresentações em Juízo Previstas</h3>
            </div>
            <div class="box-body">
                <table id="datable" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                            ...
                            <th class='col-xs-1'>Notificação</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{!! $registro->present()->notificacao !!}</td>
                            <td>{{$registro->comparecimento_dh}}</td>
                            <td>{{$registro->comparecimento_local_txt}}</td>
                            <td><a href="{{route('fdi.show',$registro->pessoa_rg)}}" target="_blanck">{{$registro->pessoa_rg}}</a></td>
