                ...
                <table id="datable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span>
                                    {{-- <a class="btn btn-default" href="{{route('local.show',$registro['id_local'])}}"><i
                                        class="fa fa-fw fa-eye "></i></a> --}}
                                    <a class="btn btn-info"
                                    href="{{route('local.restore',$registro['id_local'])}}"><i
                                        class="fa fa-fw fa-recycle "></i></a>
                                    <a class="btn btn-danger"
                                        href="{{route('local.forceDelete',$registro['id_local'])}}"
