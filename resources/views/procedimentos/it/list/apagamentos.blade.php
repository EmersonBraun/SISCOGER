...
<section class="content-header">   
  ...
  <div class='form-group col-md-12 col-xs-12' style='padding-left: 0px'>
    <div class='btn-group col-md-8 col-xs-12 ' style='padding-left: 0px'>
      <a class="btn btn-success col-md-3 col-xs-6 "  href="{{route('it.lista')}}">Lista</a>
      <a class="btn btn-default col-md-3 col-xs-6 "  href="{{route('it.andamento')}}">Andamento</a>
                ...
                <table id="datable" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-danger"  href="{{route('it.destroy',$registro['id_it'])}}" onclick="confirmApagar('it',$registro['sjd_ref'],$registro['sjd_ref_ano'])"><i class="fa fa-fw fa-trash-o "></i></a>
                        </span>
                    </td>   
                  </tr>
                  @endforeach
