...
<section class="content-header">   
    ...
    <div class='form-group col-md-12 col-xs-12' style='padding-left: 0px'>
        ...
        <a class="btn btn-sucess col-md-2 col-xs-4 "  href="{{route('ipm.rel_situacao',['ano' => $ano])}}">Rel. Situação</a> 
        ...
        <div class='col-md-2 col-xs-6  pull-right'>
            ...
            title="O ano apenas modifica a listagem,os dados continuam sendo inseridos em {{date('Y')}}"> 
                ...
                @if($i != $ano)
                    <option onclick="javascript:location.href='{{route('ipm.rel_situacao',['ano' => $i])}}'"> {{ $i }} </option>
                @endif
                @endfor  
            </select> 
            </div>
