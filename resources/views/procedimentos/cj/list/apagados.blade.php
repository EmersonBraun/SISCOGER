...
@section('content_header')
    @include('procedimentos.cj.list.menu', ['title' => 'Apagados','page' => 'apagados'])
@stop
                ...
                <table id="datable" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td class='col-xs-3 col-md-3'>
                        ...
                        <a class="btn btn-danger"  href="{{route('cj.destroy',$registro['id_cj'])}}" onclick="confirmApagar('cj',$registro['sjd_ref'],$registro['sjd_ref_ano'])"><i class="fa fa-fw fa-trash-o "></i></a>
                        </span>
                    </td>   
                  </tr>
                  @endforeach
