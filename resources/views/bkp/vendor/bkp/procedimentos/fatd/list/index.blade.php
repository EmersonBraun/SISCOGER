...
<section class="content-header nopadding">   
  ...
  <div class='form-group col-md-12 col-xs-12' style='padding-left: 0px'>
    <div class='btn-group col-md-8 col-xs-12 ' style='padding-left: 0px'>
      <a class="btn btn-success col-md-2 col-xs-4 "  href="{{route('fatd.lista',['ano' => $ano])}}">Lista</a>
    ...
    <div class='col-md-2 col-xs-6  pull-right'>
      ...
      title="O ano apenas modifica a listagem,os dados continuam sendo inseridos em {{date('Y')}}"> 
        ...
        @for ($i = date('Y'); $i >= 2008; $i--)
          @if($i != $ano)
            <option onclick="javascript:location.href='{{route('fatd.lista',['ano' => $i])}}'"> {{ $i }} </option>
          @endif
        @endfor  
      </select> 
      </div>
                ...
                <table id="datable" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-danger"  href="{{route('fatd.destroy',$registro['id_fatd'])}}" onclick="confirmApagar('fatd',$registro['sjd_ref'],$registro['sjd_ref_ano'])"><i class="fa fa-fw fa-trash-o "></i></a>
                        </span>
                    </td>   
                  </tr>
                  @endforeach
