...
@section('title', 'Restrição - Criar')

@section('content_header')
<section class="content-header">   
  <h1>Restrição - Criar</h1>
  <ol class="breadcrumb">
  <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i> Home</a></li>
  <li><a href="{{route('restricao.index')}}">Restrição - Lista</a></li>
  <li class="active">Restrição - Criar</li>
  </ol>
</section>
...
<section class="">
    <div class="tab-content">
        <v-tab-item title="Formulário principal" idp="principal" cls="active show">
            {!! Form::open(['url' => route('restricao.store')]) !!}
            ...
            {!! Form::submit('Inserir Restrição',['class' => 'btn btn-primary btn-block']) !!}
            {!! Form::close() !!}
        </v-tab-item>
    </div>
</section>
