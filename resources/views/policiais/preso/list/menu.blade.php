<section class="content-header nopadding">  
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Preso - {{$title}}</li>
    </ol>
    <br>   
    <div class="form-group col-md-12 col-xs-12 nopadding">
        <div class="btn-group col-md-6 col-xs-12 nopadding">
            ...
            href="{{route('preso.index')}}">Consulta</a>
            @if(session('is_admin'))
            <a class="btn @if($page == 'apagados') btn-success @else btn-default @endif col-md-6 col-xs-12" href="{{route('preso.apagados')}}">Apagados</a>
            @else 
        ...
        <div class="col-md-6 col-xs-12 litlepadding">
            <a class="btn btn-block btn-primary" href="{{route('preso.create')}}">
            <i class="fa fa-plus"></i> Adicionar Preso</a>
        </div>
        @endif
    <div>
</section>