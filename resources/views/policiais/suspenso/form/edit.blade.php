...
@section('title', 'Suspenso - Editar')

@section('content_header')
<section class="content-header">   
  <h1>Suspenso - Editar</h1>
  <ol class="breadcrumb">
  <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i> Home</a></li>
  <li><a href="{{route('suspenso.index')}}">Suspenso - Lista</a></li>
  <li class="active">Suspenso - Editar</li>
  </ol>
  <br>
</section>
@stop
...
<section>
    <div class="tab-content">
        <v-tab-item title="Editar Suspenso" idp="principal" cls="active show">
            ...
            <v-label label="rg" title="RG" lg="4" md="4" error="{{$errors->first('rg')}}">
                {{ Form::text('rg', null, ['class' => 'form-control ','readonly','onchange' => 'completaDados(this,nome,cargo)','onkeyup' => 'completaDados(this,nome,cargo)']) }}
            </v-label>
            ...
            {!! Form::submit('Alterar Suspenso',['class' => 'btn btn-primary btn-block']) !!}
            {!! Form::close() !!}
        </v-tab-item>
    </div>
</section>
