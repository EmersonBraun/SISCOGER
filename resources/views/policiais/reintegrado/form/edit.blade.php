...
@section('title', 'Reintegrado - Editar')

@section('content_header')
<section class="content-header">   
  <h1>Reintegrado - Editar</h1>
  <ol class="breadcrumb">
  <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i> Home</a></li>
  <li><a href="{{route('reintegrado.index')}}">Reintegrado - Lista</a></li>
  <li class="active">Reintegrado - Editar</li>
  </ol>
  <br>
</section>
@stop
...
<section>
    <div class="nav-tabs-custom">      
        <div class="tab-content">
            <v-tab-item title="Editar Reintegrado - {{$proc['nome']}}" idp="principal" cls="active show">
                {!! Form::model($proc,['url' => route('reintegrado.update',$proc['id_reintegrado']),'method' => 'put']) !!}
                ...
                {!! Form::submit('Alterar Reintegrado',['class' => 'btn btn-primary btn-block']) !!}
                {!! Form::close() !!}
            </v-tab-item>
        </div>
    </div>
