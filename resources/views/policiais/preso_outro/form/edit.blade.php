...
@section('title', 'Preso outro - Editar')

@section('content_header')
<section class="content-header">   
  <h1>Preso outro - Editar</h1>
  <ol class="breadcrumb">
  <li><a href="{{route('home')}}"><i class="fa fa-dashboard"></i> Home</a></li>
  <li><a href="{{route('presooutro.index')}}">Preso outro - Lista</a></li>
  <li class="active">Preso outro - Editar</li>
  </ol>
  <br>
</section>
@stop
...
<section>
    <div class="nav-tabs-custom">      
        <div class="tab-content">
            <v-tab-item title="Editar Preso outro - {{$proc['nome']}}" idp="principal" cls="active show">
                {!! Form::model($proc,['url' => route('presooutro.update',$proc['id_preso_outros']),'method' => 'put']) !!}
                ...
                {!! Form::submit('Alterar Prisão',['class' => 'btn btn-primary btn-block']) !!}
                {!! Form::close() !!}
            </v-tab-item>
        </div>
    </div>
