<template>
    <v-tab header="Trâmite OPM" :badge="lenght">
                            ...
                            <td>
                                <span>
                                    ...
                                    <template v-if="canDelete">
                                        <a class="btn btn-danger" @click="destroy(registro.id_tramitacaoopm)"><i class="fa fa-fw fa-trash-o "></i></a>
                                    </template>
                                </span>
                            </td>
                        </tr>
        ...
        <v-modal v-model="showModal" large effect="fade" width="70%">
            <div slot="modal-header" class="modal-header">
                <h4 class="modal-title">
                    <b v-if="registro.id_tramitacaoopm">Editar Trâmite</b>
                    <b v-else>Inserir novo Trâmite</b>
                </h4>
            </div>
            <div slot="modal-body">
                <input type="hidden" name="id" v-model="registro.id_tramitacaoopm">
                ...
                <v-label label="data" title="Início da restrição" icon="fa fa-calendar">
            ...
            <div slot="modal-footer" class="modal-footer">
                ...
                <div class="col-xs-6">
                    <v-tooltip effect="scale" placement="top" :content="msgRequired">
                        <a v-if="registro.id_tramitacaoopm" class="btn btn-success btn-block" :disabled="requireds" @click.prevent="update(registro.id_tramitacaoopm)">Editar</a>
