                    ...
                    <form id="formData" name="formData">
                        ...
                        <div :class="outros">
                            ...
                            <select name="motivo" v-model="motivo" class="form-control">
                                <option v-for="(motivo, index) in motivos" :value="motivo">{{motivo}}</option>
                            </select>
                        </div>
                        ...
                        <!-- linha termino -->
                        <div class="col-lg-4 col-md-4 col-xs-4">
                            <label for="termino_data">Data de início</label><br>
                        ...
                        <div class="col-lg-4 col-md-4 col-xs-4">
                            <label for="publicacao_termino">Publicação início</label><br>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr v-for="(sobrestamento, index) in sobrestamentos" :key="index">
                                ...
                                <td v-if="sobrestamento.motivo">{{ sobrestamento.motivo }}</td>
                                <td v-else>{{ sobrestamento.motivo_outros }}</td>
                                <td>
                                    <div class="btn-group" role="group" aria-label="First group">
                                        <a type="button"  @click="editSobrestamento(sobrestamento)" class="btn btn-danger" style="color: white">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            replaceSobrestamento(sobrestamento, index){
