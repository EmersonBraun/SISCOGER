...
class CjTest extends TestCase
{
	...
	{
		$response = $this->json('GET', '/cj/lista', []);
	...
	{
		$response = $this->json('GET', '/cj/andamento', []);
	...
	{
		$response = $this->json('GET', '/cj/prazos', []);
	...
	{
		$response = $this->json('GET', '/cj/rel_situacao', []);
	...
	{
		$response = $this->json('GET', '/cj/julgamento', []);
	...
	{
		$response = $this->json('GET', '/cj/apagados', []);
	...
	{
		$response = $this->json('GET', '/cj/criar', []);
	...
	{
		$response = $this->json('POST', '/cj/salvar', []);
	...
	{
		$response = $this->json('GET', '/cj/ver/{ref}/{ano}', []);
	...
	{
		$response = $this->json('GET', '/cj/editar/{ref}/{ano}', []);
	...
	{
		$response = $this->json('PUT', '/cj/atualizar/{id}', []);
	...
	{
		$response = $this->json('GET', '/cj/remover/{id}', []);
	...
	{
		$response = $this->json('GET', '/cj/recuperar/{id}', []);
	...
	{
		$response = $this->json('GET', '/cj/apagar/{id}', []);
