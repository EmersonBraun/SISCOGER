...
class SindicanciaTest extends TestCase
{
	...
	{
		$response = $this->json('GET', '/sindicancia/lista', []);
	...
	{
		$response = $this->json('GET', '/sindicancia/andamento', []);
	...
	{
		$response = $this->json('GET', '/sindicancia/prazos', []);
	...
	{
		$response = $this->json('GET', '/sindicancia/rel_situacao', []);
	...
	{
		$response = $this->json('GET', '/sindicancia/resultado', []);
