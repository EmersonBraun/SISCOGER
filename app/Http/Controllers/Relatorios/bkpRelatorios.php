...
// dados via API
use App\Http\Controllers\_Api\PSWD\TransferenciasApiController as TrApi;
...
class PendenciasController extends Controller
{
    ...
    public function index()
    {
        ...
        //$transferidos = TrApi::transferencias($unidade);
        $transferidos = [];

        $comportamentos = PendenciasController::comportamentos($unidade);
        $fatd_punidos = PendenciasController::fatdPunidos($unidade);
        $fatd_prazos = PendenciasController::fatdPrazos($unidade);
        $fatd_aberturas = PendenciasController::fatdAberturas($unidade);
        $ipm_prazos = PendenciasController::ipmPrazos($unidade);
        $ipm_aberturas = PendenciasController::ipmAberturas($unidade);
        $sindicancia_prazos = PendenciasController::sindicanciaPrazos($unidade);
        $sindicancia_aberturas = PendenciasController::sindicanciaAberturas($unidade);
        $cd_aberturas = PendenciasController::cdAberturas($unidade);
        $cd_prazos = PendenciasController::cdPrazos($unidade);
        ...
        $total_efetivo =  PendenciasController::totalEfetivoOPM($unidade);
    ...
    public function  transferencias($unidade)
    {
    ...
    public function fatdPunidos($unidade)
    {
    ...
    public function fatdPrazos($unidade)
    {
    ...
    public function fatdAberturas($unidade){    
    ...
    public function ipmPrazos($unidade)
    {
    ...
    public function ipmAberturas($unidade)
    {
    ...
    public function sindicanciaPrazos($unidade)
    {
    ...
    public function sindicanciaAberturas($unidade)
    {
    ...
    public function cdAberturas($unidade)
    {
    ...
    public function cdPrazos($unidade)
    {
    ...
    //TOTAL EFETIVO
    public function totalEfetivoOPM($unidade)
    {
    ...
    {
        $efetivo = PendenciasController::efetivoOPM($unidade);
    ...
    public function fatdAnos($unidade)
    {
    ...
    public function ipmAnos($unidade)
    {
        //inicializar a variável
        $ipm_ano = [];
    ...
    public function sindicanciaAnos($unidade)
    {
        //inicializar a variável
        $sindicancia_ano = [];
    ...
    public function cdAnos($unidade)
    {
        //inicializar a variável
        $cd_ano = [];
    ...
    {
        $fatd_ano = PendenciasController::fatdAnos($unidade);
        $ipm_ano = PendenciasController::ipmAnos($unidade);
        $sindicancia_ano = PendenciasController::sindicanciaAnos($unidade);
        $cd_ano = PendenciasController::cdAnos($unidade);
