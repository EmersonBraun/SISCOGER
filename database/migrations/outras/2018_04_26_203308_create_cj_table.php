...
class CreateCjTable extends Migration {
	...
	public function up()
	{
		Schema::create('cj', function(Blueprint $table)
		{
			$table->bigInteger('id_cj', true);
			...
			$table->string('libelo_file', 86)->default('');
			$table->string('doc_tipo', 5)->default('');
			$table->string('doc_numero', 8)->default('');
			$table->string('portaria_numero', 10)->default('');
			$table->date('portaria_data')->default('0000-00-00');
			$table->string('parecer_file', 86)->default('');
			$table->string('decisao_file', 86)->default('');
			$table->string('doc_prorrogacao', 25)->default('');
			$table->string('numero_tj', 25)->default('');
			...
			$table->string('ac_desempenho_bl', 1);
			$table->string('ac_conduta_bl', 1);
			$table->string('ac_honra_bl', 1);
