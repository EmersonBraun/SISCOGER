...
class CreateCdTable extends Migration {
	...
	public function up()
	{
		Schema::create('cd', function(Blueprint $table)
		{
			...
			$table->string('ac_desempenho_bl', 1)->comment('procedido incorretamento no desempenho do cargo Art 5 II A');
			$table->string('ac_conduta_bl', 1)->comment('Conduta irregular que denigra a imagem Art 5 II B');
			$table->string('ac_honra_bl', 1)->comment('Ato que afete a honra, pudonou ou decoro Art 5 II C');
