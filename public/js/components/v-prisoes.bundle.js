...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        listPrisoes: function listPrisoes() {
            var _this = this;

            var urlIndex = this.$root.baseUrl + 'api/fdi/prisoes/' + this.rg;
            if (this.rg) {
                axios.get(urlIndex).then(function (response) {
                    _this.prisoes = response.data;
...
var render = function() {
  ...
  return _c(
    "v-tab",
    { attrs: { header: "Prisões", badge: _vm.prisoes.lenght } },
    [
      _c("table", { staticClass: "table table-striped" }, [
        _c(
          ...
          [
            _vm.prisoes.lenght
              ? _vm._l(_vm.prisoes, function(prisao) {
                  return _c("tr", { key: prisao.id_prisao }, [
                    _c(
                      "td",
                      [
                        _c("b", [_vm._v("Inicio")]),
                        _vm._v(
                          ": " +
                            _vm._s(_vm._f("date_br)")(prisao.inicio_data)) +
                            " \n                    "
                        ),
                        _c("b", [_vm._v("Fim")]),
                        _vm._v(": \n                        "),
                        prisao.fim_data
                          ? [_vm._v(_vm._s(_vm._f("date_br")(prisao.fim_data)))]
                          : [_vm._v("Atual")],
                        _vm._v(
                          "\n                    (" +
                            _vm._s(prisao.comarca) +
                            "-" +
                            _vm._s(prisao.vara) +
                            ") \n                "
                        )
