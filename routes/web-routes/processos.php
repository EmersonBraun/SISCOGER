...
Route::group(['as'=>'adl.','prefix' =>'adl'],function(){
	...
	Route::get('movimentos/{ref}/{ano}',['as' =>'movimentos','uses'=>'Proc\AdlController@movimentos','middleware' => ['permission:ver-adl']]);
	Route::get('sobrestamentos/{ref}/{ano}',['as' =>'sobrestamentos','uses'=>'Proc\AdlController@sobrestamentos','middleware' => ['permission:ver-adl']]);
...
Route::group(['as'=>'cd.','prefix' =>'cd'],function(){
	...
	Route::put('atualizar/{ref}/{ano}',['as' =>'update','uses'=>'Proc\CdController@update','middleware' => ['permission:editar-cd']]);
	Route::get('movimentos/{ref}/{ano}',['as' =>'movimentos','uses'=>'Proc\CdController@movimentos','middleware' => ['permission:ver-cd']]);
	Route::get('sobrestamentos/{ref}/{ano}',['as' =>'sobrestamentos','uses'=>'Proc\CdController@sobrestamentos','middleware' => ['permission:ver-cd']]);
...
Route::group(['as'=>'cj.','prefix' =>'cj'],function(){
	...
	Route::put('atualizar/{ref}/{ano}',['as' =>'update','uses'=>'Proc\CjController@update','middleware' => ['permission:editar-cj']]);
	Route::get('movimentos/{ref}/{ano}',['as' =>'movimentos','uses'=>'Proc\CjController@movimentos','middleware' => ['permission:ver-cj']]);
	Route::get('sobrestamentos/{ref}/{ano}',['as' =>'sobrestamentos','uses'=>'Proc\CjController@sobrestamentos','middleware' => ['permission:ver-cj']]);
...
Route::group(['as'=>'fatd.','prefix' =>'fatd'],function(){
	...
	Route::get('movimentos/{ref}/{ano}',['as' =>'movimentos','uses'=>'Proc\FatdController@movimentos','middleware' => ['permission:ver-fatd']]);
	Route::get('sobrestamentos/{ref}/{ano}',['as' =>'sobrestamentos','uses'=>'Proc\FatdController@sobrestamentos','middleware' => ['permission:ver-fatd']]);
...
Route::group(['as'=>'pad.','prefix' =>'pad'],function(){
	...
	Route::put('atualizar/{ref}/{ano}',['as' =>'update','uses'=>'Proc\PadController@update','middleware' => ['permission:editar-pad']]);
	Route::get('movimentos/{ref}/{ano}',['as' =>'movimentos','uses'=>'Proc\PadController@movimentos','middleware' => ['permission:ver-pad']]);
	Route::get('sobrestamentos/{ref}/{ano}',['as' =>'sobrestamentos','uses'=>'Proc\PadController@sobrestamentos','middleware' => ['permission:ver-pad']]);
