...
Route::group(['as'=>'cd.','prefix' =>'cd'],function(){
	...
	Route::get('movimentos/{ref}/{ano}',['as' =>'movimentos','uses'=>'Proc\MovimentoController@movimentos','middleware' => ['permission:ver-cd']]);
	Route::get('sobrestamentos/{ref}/{ano}',['as' =>'sobrestamentos','uses'=>'Proc\SobrestamentoController@sobrestamentos','middleware' => ['permission:ver-cd']]);
...
Route::group(['as'=>'cj.','prefix' =>'cj'],function(){
	...
	Route::get('movimentos/{ref}/{ano}',['as' =>'movimentos','uses'=>'Proc\MovimentoController@movimentos','middleware' => ['permission:ver-cj']]);
	Route::get('sobrestamentos/{ref}/{ano}',['as' =>'sobrestamentos','uses'=>'Proc\SobrestamentoController@sobrestamentos','middleware' => ['permission:ver-cj']]);
...
Route::group(['as'=>'fatd.','prefix' =>'fatd'],function(){
	...
	Route::get('movimentos/{ref}/{ano}',['as' =>'movimentos','uses'=>'Proc\MovimentoController@movimentos','middleware' => ['permission:ver-fatd']]);
	Route::get('sobrestamentos/{ref}/{ano}',['as' =>'sobrestamentos','uses'=>'Proc\SobrestamentoController@sobrestamentos','middleware' => ['permission:ver-fatd']]);
...
Route::group(['as'=>'pad.','prefix' =>'pad'],function(){
	...
	Route::get('movimentos/{ref}/{ano}',['as' =>'movimentos','uses'=>'Proc\MovimentoController@movimentos','middleware' => ['permission:ver-pad']]);
	Route::get('sobrestamentos/{ref}/{ano}',['as' =>'sobrestamentos','uses'=>'Proc\SobrestamentoController@sobrestamentos','middleware' => ['permission:ver-pad']]);
